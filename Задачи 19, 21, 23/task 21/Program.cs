...
int segment1 = xFromPointB - xFromPointA; //Находим расстояние между двумя координатами
int segment2 = yFromPointB - yFromPointA;
int segment3 = zFromPointB - zFromPointA;

double lengthWithOutRound = Math.Sqrt(segment1*segment1 + segment2*segment2 + segment3*segment3); //Возводим в квадрат сумму квадратов расстояния между координатами
double lengthWithRound = Math.Round(lengthWithOutRound, 2); //Этим действием округляем знаки после запятой до двух
